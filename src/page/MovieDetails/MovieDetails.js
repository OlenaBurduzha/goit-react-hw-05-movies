    ...
    <section>
      ...
      {movieDetail && (
        <div className={styles.section}>
          {movieDetail.poster_path ? <img className={styles.image}
          ...
          <div>
            ...
            <p className={styles.main_title} key={nanoid()}>
              User score:
              <span className={styles.line}>{Number.parseInt(movieDetail.vote_average * 10)} &#37;</span>
            </p>
            <p className={styles.main_title} key={nanoid()}>
              Overview: <br/><span className={styles.line}>{movieDetail.overview}</span>
            </p>
            <p className={styles.main_title} key={nanoid()}>
              Genres: <br />
      ...
      <ul className={styles.link_list}>
        <li className={styles.item} key={nanoid()}><Link to="cast" state={{ from: location.state.from }}>Cast</Link></li>
        <li className={styles.item} key={nanoid()}><Link to="reviews" state={{ from: location.state.from }}>Reviews</Link></li>
      </ul>
